...
interface IModelDB extends IIterable<IDBTable<{}>> {
   ...
   */
  readonly changed: ISignal<IModelDB, IModelDB.ChangedArgs>;
  ...
  /**
   * Test whether the model db has a specific table.
   *
   * @param token - The token for the table of interest.
   *
   * @returns `true` if the  model db has the table, `false` otherwise.
   */
...
/**
 * The namespace for the `IModeDB` interface statics.
 */
export
namespace IModelDB {
  /**
   * The metadata for a db object change.
   */
  export
  type ChangeMetadata = {
    /**
  ...
  /**
   * The type description of a change to a model db.
   */
  export
  type Change = ChangeMetadata & {
    /**
     * The tables that were removed from the model.
     */
    readonly removed: ReadonlyArray<IDBTable<{}>>;

    /**
     * The tables that were added to the model.
     */
   ...
   */
  export
  type ChildChangedArgs = (
    IDBTable.ChangedArgs<{}> |
    DBRecord.ChangedArgs<{}> |
    IDBList.ChangedArgs |
    IDBMap.ChangedArgs |
    IDBString.ChangedArgs
  );
   ...
   */
  export
  type ChangedArgs = ChildChangedArgs | {
    /**
 ...
 */
export
interface IDBList<T extends ReadonlyJSONValue = ReadonlyJSONValue> extends IIterable<T>, IRetroable<T> {
  /**
   ...
   * The changed signal is emitted asynchronously.
   */
  readonly changed: ISignal<IDBList<T>, IDBList.ChangedArgs<T>>;
  ...
  /**
   * The db model which created the object.
   *
   * #### Complexity
   * Constant.
   */
  readonly dbModel: IModelDB;
...
namespace IDBList {
  /**
   * The type description of a change to a db list.
   */
  export
  type Change<T extends ReadonlyJSONValue = ReadonlyJSONValue> = IModelDB.ChangeMetadata & {
    /**
   ...
   */
  export
  type ChangedArgs<T extends ReadonlyJSONValue = ReadonlyJSONValue> = {
    /**
     * The type of the change.
     */
     ...
     */
    readonly changes: ReadonlyArray<Change<T>>;
  };
}
 ...
 */
export
interface IDBMap<T extends ReadonlyJSONValue = ReadonlyJSONValue> extends IIterable<[string, T]> {
  /**
   * A signal emitted when the object changes.
   *
   * #### Notes
   * The changed signal is emitted asynchronously.
   */
  readonly changed: ISignal<IDBMap<T>, IDBMap.ChangedArgs<T>>;
...
namespace IDBMap {
  /**
   * The type description of a change to a db map.
   */
  export
  type Change<T extends ReadonlyJSONValue = ReadonlyJSONValue> = IModelDB.ChangeMetadata & {
    /**
...
interface IDBString {
   ...
   * The changed signal is emitted asynchronously.
   */
  readonly changed: ISignal<IDBString, IDBString.ChangedArgs>;
...
namespace IDBString {
  /**
   * The type description of a change to a db string.
   */
  export
  type Change = IModelDB.ChangeMetadata & {
    /**
     * The index of the modification.
     */
    readonly index: number;
...
namespace DBRecord {
  ...
  /**
   * The type description of a change to a db record.
   */
  export
  type Change<T extends State> = IModelDB.ChangeMetadata & {
    /**
  ...
  /**
   * A type alias for the db record child changed arguments.
   */
  export
  type ChildChangedArgs = (
    IDBList.ChangedArgs |
   ...
   */
  export
  type ChangedArgs<T extends State> = ChildChangedArgs | {
    /**
     * The type of the change.
     */
...
interface IDBTable<T extends DBRecord.State> extends IIterable<DBRecord<T>> {
   ...
   * The changed signal is emitted asynchronously.
   */
  readonly changed: ISignal<IDBTable<T>, IDBTable.ChangedArgs<T>>;
...
namespace IDBTable {
  /**
   * The type description of a change to a db table.
   */
  export
  type Change<T extends DBRecord.State> = IModelDB.ChangeMetadata & {
    /**
  ...
  /**
   * A type alias for the db table child changed arguments.
   */
  export
  type ChildChangedArgs<T extends DBRecord.State> = (
    DBRecord.ChangedArgs<T> |
    IDBList.ChangedArgs |
    IDBMap.ChangedArgs |
    IDBString.ChangedArgs
  );
   ...
   */
  export
  type ChangedArgs<T extends DBRecord.State> = ChildChangedArgs<T> | {
    /**
     * The type of the change.
     */
