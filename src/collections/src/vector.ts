...
|----------------------------------------------------------------------------*/
import {
  ArrayIterator, IIterable, IIterator, IterableOrArrayLike, each
 ...
 */
export
class Vector<T> implements IIterable<T> {
  /**
   ...
   *
   * @returns The front value, or `undefined` if the vector is empty.
   *
   * #### Complexity
   * Constant.
   *
   ...
   *
   * @returns The back value, or `undefined` if the vector is empty.
   *
   * #### Complexity
   * Constant.
   *
  ...
  /**
   * Push a value onto the back of the vector.
   *
