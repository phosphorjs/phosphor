...
class CommandRegistry {
   ...
   *
   * @param options - The options for initializing the registry.
   */
  constructor(options: CommandRegistry.IOptions = {}) {
    this._keyboardLayout = options.keyboardLayout || EN_US;
  }
   ...
   */
  get keyboardLayoutChanged(): ISignal<this, CommandRegistry.IKeyboardLayoutChangedArgs> {
    return this._keyboardLayoutChanged;
  }

  /**
   * Get the keyboard layout used by the registry.
   */
  ...
  /**
   * Set the keyboard layout used by the registry.
   */
  set keyboardLayout(value: IKeyboardLayout) {
    let old = this._keyboardLayout;
    if (old === value) {
      return;
    }
    this._keyboardLayout = value;
    this._keyboardLayoutChanged.emit({ oldValue: old, newValue: value });
  }
  ...
  private _keyboardLayout: IKeyboardLayout;
  ...
  private _keyboardLayoutChanged = new Signal<this, CommandRegistry.IKeyboardLayoutChangedArgs>(this);
}
...
namespace CommandRegistry {
  /**
   * An options object for initializing a command registry.
   */
  export
  interface IOptions {
    /**
     * The keyboard layout to use with the registry.
     *
  ...
  /**
   * An arguments object for the `keyboardLayoutChanged` signal.
   */
  export
  interface IKeyboardLayoutChangedArgs {
    /**
